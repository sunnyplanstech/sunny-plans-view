...
const tiers = [
  {
    name: "Free Tier",
    price: "Free",
    description: "Get started with land insights—no card required. Focus on one state (chosen at signup).",
    features: [
      "Top-ranked parcels with masked contact info",
  ...
  },
  {
    ...
    features: [
      ...
      "Solar suitability scores (SunnyScore\u2122)",
      "Substation & transformer proximity analysis",
