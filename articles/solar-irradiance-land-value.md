...
Parcels in Ohio and Indiana — states with moderate irradiance at best — routinely attract offers in the same range as land in Arizona or New Mexico, which receive roughly 60% more sunlight per year. Sometimes the Midwest parcel goes for more. The reasons have less to do with the sun and more to do with what stands between the land and a working solar project.
...
At typical long-term electricity contract rates, those extra 30,000 MWh represent the margin between a project that meets its return target and one that doesn't — compounded across a 25-year term.

## How Irradiance Translates to Project Revenue
...
Land prices work against the irradiance premium from the other direction. High-irradiance parcels in the Southwest are priced higher in the private market, which compresses developer margins. Agricultural land in Ohio or Indiana comes in cheaper, and a lower lease rate per acre still represents a workable position given lower acquisition costs.

State procurement policy often matters more than any of these. When a state requires utilities to source a share of their power from renewables, utilities issue competitive procurement requests that create consistent developer demand. Georgia Power runs regular solicitations for new solar capacity, and Ohio has an active market for renewable energy certificates — the tradable credits utilities buy to demonstrate they've met their renewables quota. Both states have supported active solar development despite irradiance resources well below what the Southwest offers.

## How Irradiance Varies Across the US

| Region | Approximate GHI (kWh/m²/year) | Notes |
|---|---|---|
| Southwest (AZ, NM, NV, CA desert) | 2,100–2,400 | Highest irradiance in the contiguous US |
| Southeast (TX, FL, GA, SC) | 1,750–2,050 | Strong resource; humidity provides partial offset |
| Mid-Atlantic & Upper South (VA, NC, TN) | 1,550–1,750 | Adequate for utility-scale; declining at the margin |
...
*Sunnyplans calculates a SunnyScore for every indexed parcel based on solar potential and grid proximity — the two inputs that most directly determine whether a developer's economics work on a specific site.*
