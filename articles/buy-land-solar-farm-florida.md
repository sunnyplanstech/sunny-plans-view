---
title: "How to Buy Land for a Solar Farm in Florida in 2026"
description: "Florida has no independent grid operator, and FPL controls interconnection for half the state while competing with independent developers to build solar on it. What that means for site selection — and where viable land still exists."
date: "2026-04-24"
...
*Sunnyplans shows substation and transformer distances at the parcel level for Florida listings, alongside a SunnyScore that weights grid proximity and solar potential. If you want to see which parcels in Florida have already cleared the NWI and protected area filters, browse [solar land listings in Florida](https://sunnyplans.com/united-states/florida) by county.*

---

**Sources**
- SEIA, *Florida Solar and Storage* — state capacity data and policy overview — [seia.org/state-solar-policy/florida-solar](https://seia.org/state-solar-policy/florida-solar/)
- FERC, *Order 2023: Improvements to Generator Interconnection Procedures and Agreements* — interconnection reform and applicability to non-RTO utilities — [ferc.gov/media/order-no-2023](https://www.ferc.gov/media/order-no-2023)
- NextEra Energy / FPL, *FPL Clean Energy Connection* — FPL OASIS and interconnection process — [fpl.com/clean-energy/interconnection.html](https://www.fpl.com/clean-energy/interconnection.html)
