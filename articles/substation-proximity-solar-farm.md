...
That structure is why grid proximity shapes the offer more than [solar irradiance](/blog/solar-irradiance-land-value) does in most markets. Irradiance is relatively consistent across the regions where solar is actively developed. Interconnection cost can swing by millions on a single distance variable, and that swing compresses directly into the lease.
...
- CISA / HIFLD, *Electric Substations dataset* — national substation locations, voltage classes, and ownership — [catalog.data.gov/dataset/electric-substations](https://catalog.data.gov/dataset/electric-substations)
