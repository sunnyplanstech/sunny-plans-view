---
title: "Land Requirements for Battery Storage (BESS) Projects: What's Different from Solar"
description: "Battery storage projects look similar to solar farms from the road, but the site criteria are meaningfully different. Acreage, grid proximity, zoning classification, and fire codes — what developers screen for and where the real constraints are."
date: "2026-04-09"
